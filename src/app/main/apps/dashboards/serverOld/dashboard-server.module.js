(function ()
{
    ...
    angular
        .module('app.dashboards.serverOld', [])
        .config(config);
    ...
    {
        // State
        $stateProvider.state('app.dashboards_server_old', {
            url      : '/dashboard-server-old',
            views    : {
                'content@app': {
                    templateUrl: 'app/main/apps/dashboards/serverOld/dashboard-server.html',
